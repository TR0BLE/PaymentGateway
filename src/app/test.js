  ...
  "lib/helpers": function (exports, require, module) {
    (function () {
      ...
      helpers = {
        ...
        iOSBuildVersion: uaVersionFn(
          /(?:iPhone OS |iPad; CPU OS )\d+_\d+_(\d+)/
        ),
        androidWebkitVersion: uaVersionFn(
          /Mozilla\/5\.0.*Android.*AppleWebKit\/([\d]+)/
        ),
        ...
        isIE: function () {
          return /(MSIE ([0-9]{1,}[\.0-9]{0,})|Trident\/)/i.test(
            helpers.userAgent
          );
        },
        isChrome: function () {
        ...
        isAndroidWebView: function () {
          return (
            helpers.isAndroidChrome() &&
            /Version\/\d+\.\d+/.test(helpers.userAgent)
          );
        },
        isAndroidFacebookApp: function () {
          return (
            helpers.isAndroidChrome() &&
            /FBAV\/\d+\.\d+/.test(helpers.userAgent)
          );
        },
        isNativeWebContainer: function () {
          return (
            window.cordova != null || /GSA\/\d+\.\d+/.test(helpers.userAgent)
          );
        },
        ...
        isAndroidWebapp: function () {
          ...
          metaTag =
            document.getElementsByName("apple-mobile-web-app-capable")[0] ||
            document.getElementsByName("mobile-web-app-capable")[0];
        ...
        isiOSBroken: function () {
          ...
          if (
            helpers.iOSVersion() === 9 &&
            helpers.iOSMinorVersion() >= 2 &&
            chromeVersion &&
            chromeVersion <= 47
          ) {
            return true;
        ...
        couldBeBrokenSFSVC: function () {
          ...
          return (
            (iOSVersion === 9 || iOSVersion === 10) &&
            !helpers.isiOSWebView() &&
            !helpers.isiOSChrome() &&
            !helpers.isiOSFirefox() &&
        ...
        getViewportTags: function () {
          var j,
            ...
            viewport,
            viewportContent;
          metaTags = Array.prototype.slice
            .call(document.getElementsByTagName("meta"))
            .filter(function (tag) {
              return (
                tag.name === "viewport" && tag.getAttribute("content") != null
              );
            });
          if (!metaTags.length) {
            return {};
        ...
        isFullscreenMobileCapableViewport: function () {
          ...
          initialScaleIsOK =
            !!viewportTags["initial-scale"] &&
            parseInt(viewportTags["initial-scale"], 10) === 1;
          widthIsOK =
            !viewportTags["width"] || viewportTags["width"] === "device-width";
          heightIsOK =
            !viewportTags["height"] ||
            viewportTags["height"] === "device-height";
          return initialScaleIsOK && widthIsOK && heightIsOK;
        },
        iOSChromeTabViewWillFail: function () {
          var isUserGesture, ref, ref1;
          isUserGesture =
            (ref = (ref1 = window.event) != null ? ref1.type : void 0) ===
              "click" ||
            ref === "touchstart" ||
            ref === "touchend";
        ...
        isSmallScreen: function () {
          return (
            Math.min(window.screen.availHeight, window.screen.availWidth) <=
              640 || /FakeCheckoutMobile/.test(helpers.userAgent)
          );
        },
        ...
        strip: function (html) {
          ...
          tmp.innerHTML = html;
          return (ref =
            (ref1 = tmp.textContent) != null ? ref1 : tmp.innerText) != null
            ? ref
            : "";
        },
        ...
        setAutocomplete: function (el, type) {
          var secureCCFill;
          secureCCFill =
            helpers.chromeVersion() > 14 || helpers.safariVersion() > 7;
          ...
          if (
            !(
              /name|honorific/.test(type) ||
              type === "locality" ||
              type === "city" ||
              type === "adminstrative-area" ||
              type === "state" ||
              type === "province" ||
              type === "region" ||
              type === "language" ||
              type === "org" ||
              type === "organization-title" ||
              type === "sex" ||
              type === "gender-identity"
            )
          ) {
    ...
    (function () {
      ...
      module.exports = {
        levenshtein: (levenshtein = function (str1, str2) {
          ...
          for (
            i = o = 1, ref2 = m;
            1 <= ref2 ? o <= ref2 : o >= ref2;
            i = 1 <= ref2 ? ++o : --o
          ) {
            for (
              j = p = 1, ref3 = n;
              1 <= ref3 ? p <= ref3 : p >= ref3;
              j = 1 <= ref3 ? ++p : --p
            ) {
  ...
  "lib/paymentMethods": function (exports, require, module) {
    (function () {
      var ERROR,
        ...
        ref,
        ref1,
        simpleMethodTypeCheck,
        simpleToCanonical,
        singleMethodTypeCheck,
        spec,
        transformMethods,
      ...
      (ref = optionValidator.severities),
        (ERROR = ref.ERROR),
        (WARNING = ref.WARNING);
      (ref1 = optionValidator.importances),
        (OPTIONAL = ref1.OPTIONAL),
        (REQUIRED = ref1.REQUIRED),
        (PRIVATE = ref1.PRIVATE);
        ...
        if (type !== "boolean" && val !== "auto") {
          ...
          return {
            ...
            message:
              "The '" +
              prettyAlipay +
              "' option can be true, false, or 'auto', but instead we found " +
              optionHelpers.dumpObject(val) +
              ".",
          };
        } else {
          return null;
        ...
        if (!isValidMethod(method)) {
          ...
          return {
            ...
            message:
              "'" +
              method +
              "' is not a valid payment method. It must be one of " +
              PRETTY_METHODS,
          };
        } else {
          return null;
      ...
      deepMethodTypeCheck = function (methodSettings) {
        ...
        (ref2 = optionValidator.validate(optionSpec, methodSettings)),
          (errors = ref2.errors),
          (warnings = ref2.warnings);
        errors = errors.concat(warnings);
        if (errors.length > 0) {
          return {
            type: ERROR,
            message:
              "Error when checking the '" +
      ...
      singleMethodTypeCheck = function (method, idx) {
        ...
        if (typeof method === "string") {
          ...
          return {
            type: ERROR,
            message:
              "All elements of paymentMethods need to be either an object with a 'method' property or one of these strings: " +
              PRETTY_METHODS +
              ".\n At index " +
              idx +
              " we found '" +
      ...
      spec = function (key, val, options) {
        ...
        if (!helpers.isArray(val)) {
          ...
          return {
            type: ERROR,
            message:
              "Looking for an Array, but instead we found '" +
              actualType +
              "'.",
          };
        }
        ...
        for (idx = i = 0, len = ref2.length; i < len; idx = ++i) {
          ...
          if (method === sortedMethods[idx]) {
            return {
              type: ERROR,
              message:
                "You've configured the payment method '" +
                method +
                "' multiple times.",
            };
          }
      ...
      checkNoOldAPI = function (options) {
        ...
        if (
          options.alipay != null ||
          options.bitcoin != null ||
          options.alipayReusable != null
        ) {
          ...
          return {
            type: ERROR,
            message:
              "Setting any of the the '" +
              alipay +
              "', '" +
              alipayReusable +
              "', or '" +
              bitcoin +
              "' options is disallowed if you are using '" +
              paymentMethods +
              "'.",
          };
        } else {
      ...
      coerceDefaults = function (methodSpec, methodSettings) {
        ...
        for (setting in methodSpec) {
          if (methodSettings[setting] == null) {
            results.push(
              (methodSettings[setting] = methodSpec[setting]["default"])
            );
          } else {
            results.push(void 0);
          }
      ...
      simpleToCanonical = function (method, enabled) {
        var methodSettings;
        methodSettings = { method: method, enabled: enabled };
      ...
      methodsArrayToDict = function (paymentMethods) {
        ...
        return { settings: settings, enabled: enabled };
      };
      canonicalize = function (rawOptions) {
        ...
        if (rawOptions.paymentMethods != null) {
          result.paymentMethods = methodsArrayToDict(
            transformMethods(rawOptions.paymentMethods)
          );
        } else {
          hasAlipay = rawOptions.alipay || rawOptions.alipayReusable || false;
          result.paymentMethods = methodsArrayToDict([
            simpleToCanonical("card", true),
            simpleToCanonical("bitcoin", rawOptions.bitcoin || false),
            alipayToCanonical(hasAlipay, rawOptions.alipayReusable),
          ]);
        }
        return result;
      };
      ...
      OPTIONS = {
        address: {
          ...
          checkContext: function (key, val, options) {
            ...
            prettyBilling = optionHelpers.prettyPrint(
              "billingAddress",
              options
            );
            return {
        ...
        amount: { importance: OPTIONAL, type: NULLABLE_NUMBER },
        billingAddress: { importance: OPTIONAL, type: NULLABLE_BOOLEAN },
        bitcoin: { importance: OPTIONAL, type: NULLABLE_BOOLEAN },
        buttonIntegration: {
          importance: PRIVATE,
          type: BOOLEAN,
          default: false,
        },
        closed: { only: CUSTOM, importance: OPTIONAL, type: OTHER },
        color: { importance: PRIVATE, type: STRING },
        createSource: { importance: PRIVATE, type: BOOLEAN },
        currency: {
          importance: OPTIONAL,
          type: NULLABLE_STRING,
          default: "usd",
        },
        description: { importance: OPTIONAL, type: NULLABLE_STRING },
        email: { importance: OPTIONAL, type: NULLABLE_STRING },
        image: { importance: OPTIONAL, type: NULLABLE_URL },
        key: { importance: REQUIRED, type: STRING },
        label: { only: BUTTON, importance: OPTIONAL, type: NULLABLE_STRING },
        locale: { importance: OPTIONAL, type: NULLABLE_STRING },
        name: { importance: OPTIONAL, type: NULLABLE_STRING },
        nostyle: { importance: PRIVATE, type: BOOLEAN },
        notrack: { importance: PRIVATE, type: BOOLEAN },
        opened: { only: CUSTOM, importance: OPTIONAL, type: OTHER },
        panelLabel: { importance: OPTIONAL, type: NULLABLE_STRING },
        paymentMethods: {
          only: CUSTOM,
          importance: OPTIONAL,
          type: OTHER,
        ...
        referrer: { importance: PRIVATE, type: URL },
        shippingAddress: {
          importance: OPTIONAL,
          type: NULLABLE_BOOLEAN,
          checkContext: optionValidator.xRequiresY(
            "shippingAddress",
            "billingAddress"
          ),
        },
        ...
        supportsTokenCallback: { importance: PRIVATE, type: BOOLEAN },
        timeLoaded: { importance: PRIVATE, type: OTHER },
        token: {
        ...
        trace: { importance: PRIVATE, type: BOOLEAN },
        url: { importance: PRIVATE, type: URL },
        zipCode: { importance: OPTIONAL, type: NULLABLE_BOOLEAN },
        __originals: { importance: PRIVATE, type: OTHER },
      };
...
StripeCheckout.require.define({
  "lib/optionValidator": function (exports, require, module) {
    (function () {
      var ERROR,
        ErrorMissingOneOfRequired,
        ErrorMissingRequired,
        ErrorMisspelledRequired,
        OPTIONAL,
        PRIVATE,
        REQUIRED,
        WARNING,
        WarnBadContext,
        WarnMisspelledOptional,
        WarnOptionTypeError,
        WarnUnrecognized,
        checkConditionallyRequiredOptions,
        checkOptionContexts,
        checkOptionTypes,
      ...
      ErrorMissingRequired = (function () {
        ...
        ErrorMissingRequired.prototype.trackedInfo = function () {
          return { result: "ErrorMissingRequired", key: this.key };
        };
      ...
      ErrorMissingOneOfRequired = (function () {
        ...
        ErrorMissingOneOfRequired.prototype.toString = function () {
          ...
          return (
            ...
            "' or '" +
            keyB +
            "' is a required option, but neither was found."
          );
        };
        ErrorMissingOneOfRequired.prototype.trackedInfo = function () {
          return { result: "ErrorMissingOneOfRequired", key: this.keyA };
        };
      ...
      WarnUnrecognized = (function () {
        ...
        WarnUnrecognized.prototype.trackedInfo = function () {
          return { result: "WarnUnrecognized", key: this.key };
        };
      ...
      checkUnrecognizedOptions = function (OPTIONS, arg, rawOptions) {
        ...
        for (option in rawOptions) {
          if (!(option in OPTIONS.all)) {
            suggestion = spellChecker.suggest(
              OPTIONS.suggestable,
              option,
              THRESHOLD
            );
            if (
              indexOf.call(OPTIONS.required, suggestion) >= 0 ||
              indexOf.call(OPTIONS.conditionallyRequired, suggestion) >= 0
            ) {
              missingRequiredErrors = (function () {
                ...
                for (idx = i = 0, len = errors.length; i < len; idx = ++i) {
                  err = errors[idx];
                  if (
                    (err instanceof ErrorMissingRequired &&
                      err.key === suggestion) ||
                    (err instanceof ErrorMissingOneOfRequired &&
                      err.keyA === suggestion)
                  ) {
                    results.push(idx);
                  }
              ...
              if (missingRequiredErrors.length > 0) {
                ...
                errors[idx] = new ErrorMisspelledRequired(
                  rawOptions,
                  suggestion,
                  option
                );
              ...
              warnings.push(
                new WarnMisspelledOptional(rawOptions, suggestion, option)
              );
            } else {
              warnings.push(new WarnUnrecognized(rawOptions, option));
            }
  ...
  "lib/optionParser": function (exports, require, module) {
    (function () {
      ...
      _trackIndividual = function (level, origin, rawOptions, error) {
        ...
        parameters = { "optchecker-origin": origin };
      ...
      module.exports = {
        coerceButtonOption: function (option, val) {
          return optionValidator.coerceOption(
            optionSpecs.buttonConfigureOptions,
            option,
            val
          );
        },
        parse: function (rawOptions) {
          ...
          if (
            rawOptions.address != null &&
            rawOptions.address !== "false" &&
            rawOptions.address !== false
          ) {
            parsed.billingAddress = true;
          }
        ...
        checkUsage: function (origin, rawOptions, isDarkMode) {
          ...
          (ref = optionValidator.validate(OPTIONS, rawOptions)),
            (errors = ref.errors),
            (warnings = ref.warnings);
          numErrors = errors.length;
          numWarnings = warnings.length;
          trackSummary(
            { origin: origin, numErrors: numErrors, numWarnings: numWarnings },
            rawOptions
          );
...
StripeCheckout.require.define({
  "lib/keymode": function (exports, require, module) {
    (function () {
      ...
      KEY_MODES = { live: "live", test: "test", unknown: "unknown" };
      ...
      module.exports = { fromKey: fromKey, KEY_MODES: KEY_MODES };
    }.call(this));
  },
});
StripeCheckout.require.define({
    ...
    (function () {
      ...
      RPC = (function () {
        ...
        RPC.prototype.sendMessage = function (method, args) {
          ...
          if (
            ((ref = this.target) != null ? ref.postMessage : void 0) == null
          ) {
            err = new Error(
              "Unable to communicate with Checkout. Please contact support@stripe.com if the problem persists."
            );
        ...
        RPC.prototype.processMessage = function (data) {
          ...
          if (
            ["frameReady", "frameCallback", "isAlive"].indexOf(data.method) !==
            -1
          ) {
            result = null;
            ...
            result =
              typeof (base = this.methods)[(name = data.method)] === "function"
                ? base[name].apply(base, data.args)
                : void 0;
          }
    ...
    (function () {
      ...
      setCookie = function (name, value, options) {
        ...
        if (typeof options.expires === "number") {
          expires = new Date();
          expires.setTime(
            expires.getTime() + options.expires * 24 * 60 * 60 * 1e3
          );
      ...
      canTrack = function () {
        var dnt, ref;
        dnt =
          (ref = window.navigator.doNotTrack) != null
            ? ref.toString().toLowerCase()
            : void 0;
        switch (dnt) {
          case "1":
          case "yes":
      ...
      track = function (event, params, callback) {
        ...
        request_params = { event: event, rf: window.location.host };
        for (k in params) {
          v = params[k];
    ...
    (function () {
      ...
      tracker.track = {
        ...
        manhattanStatusSet: function (isEnabled) {
          return track("outer.manhattanStatus", { isEnabled: isEnabled });
        },
        tabOpeningError: function () {
          return track("outer.tabOpeningError");
        },
        viewport: function (viewport) {
          return track("outer.viewport", { viewport: viewport });
        },
        iOSWebViewType: function () {
          var type;
          type = helpers.getiOSWebViewType();
          if (type) {
            return track("inner.iOSWebViewType", { type: type });
          }
        },
        ...
        configSummary: function (parameters, options) {
          setOptions(options);
          return track("config.summary", parameters, [
            "optchecker-origin",
            "optchecker-numErrors",
            "optchecker-numWarnings",
          ]);
        },
        configError: function (parameters, options) {
          setOptions(options);
          return track("config.error", parameters, [
            "optchecker-origin",
            "optchecker-result",
          ]);
        },
        configWarning: function (parameters, options) {
          setOptions(options);
          return track("config.warning", parameters, [
            "optchecker-origin",
            "optchecker-result",
          ]);
        },
        ...
        invalid: function (parameters) {
          if (parameters["err"] == null && parameters["fields"] == null) {
            throw new Error(
              "Cannot track invalid because err or fields should be provided"
            );
          }
          return track("invalid", parameters);
        },
        tokenError: function (msg) {
          return track("token.error", { message: msg, type: "exception" });
        },
        sourceError: function (msg) {
          return track("source.error", { message: msg, type: "exception" });
        },
        moreInfo: function () {
        ...
        i18nLocKeyMissing: function (key) {
          return track("i18n.loc.missingKey", { template_key: key });
        },
        ...
        i18nFormatLocaleMissing: function (locale) {
          return track("i18n.format.localeMissing", { locale: locale });
        },
        ...
        phoneVerificationAuthorize: function (parameters) {
          return track("fraudCodeVerification.authorize", parameters, [
            "valid",
          ]);
        },
      ...
      tracker.trace = {
        trigger: function (eventName, args) {
          ...
          if (indexOf.call(EXCLUDED_EVENTS, eventName) < 0) {
            ...
            return this._triggerTimeout != null
  ...
  "outer/lib/utils": function (exports, require, module) {
    (function () {
      ...
      remove = function (element) {
        var ref;
        return (ref = element.parentNode) != null
    ...
    (function () {
      ...
      App = (function () {
        function App(options) {
          ...
          this.setForceManhattan = bind(this.setForceManhattan, this);
          ...
          if (
            ...
            console.error(
              "Stripe Checkout is not compatible with your version of Prototype.js. Please upgrade to version 1.7 or greater."
            );
          }
        }
        ...
        App.prototype.close = function (buttonId) {
          var ref;
          return (ref = this.checkouts[buttonId]) != null
            ? ref.close()
            : void 0;
        };
        App.prototype.configure = function (buttonId, options) {
          ...
          this.checkouts[buttonId] = new Checkout(
            new TokenCallback(options),
            this.constructorOptions,
            options
          );
        ...
        App.prototype.validateOptions = function (options, which) {
          ...
          try {
            ...
            throw new Error(
              "Stripe Checkout was unable to serialize the options passed to StripeCheckout." +
                which +
                "(). Please consult the doumentation to confirm that you're supplying values of the expected type: " +
                url
            );
          }
        };
        ...
        App.prototype.trackOpen = function (checkout, options) {
          var data;
          this.enableTracker(options);
          data = { key: options.key, lsid: "NA", cid: "NA" };
...
StripeCheckout.require.define({
  "outer/controllers/button": function (exports, require, module) {
    (function () {
      ...
      (ref = require("outer/lib/utils")),
        ($$ = ref.$$),
        (hasClass = ref.hasClass),
        (addClass = ref.addClass),
        (trigger = ref.trigger),
        (append = ref.append),
        (text = ref.text),
        (parents = ref.parents),
        (insertAfter = ref.insertAfter),
        (hasAttr = ref.hasAttr),
        (resolve = ref.resolve);
      helpers = require("lib/helpers");
      optionParser = require("lib/optionParser");
      Button = (function () {
        ...
        Button.prototype.render = function () {
          ...
          this.$style.setAttribute(
            "href",
            this.app.getHost() +
              "/v3/checkout/button-qpwW2WfkB0oGWVWIASjIOQ.css"
          );
        ...
        Button.prototype.formatKey = function (key) {
          ...
          for (i = 0, len = args.length; i < len; i++) {
            ...
            if (arg.length > 0) {
              key =
                key +
                arg.substr(0, 1).toUpperCase() +
                arg.substr(1).toLowerCase();
            }
          }
          return "stripe" + key;
        };
        ...
        Button.prototype.parentForm = function () {
          ...
          for (i = 0, len = elements.length; i < len; i++) {
            el = elements[i];
            if (
              ((ref1 = el.tagName) != null ? ref1.toLowerCase() : void 0) ===
              "form"
            ) {
              return el;
            }
        ...
        Button.prototype.parentHead = function () {
          var ref1, ref2;
          return (
            ((ref1 = this.document) != null ? ref1.head : void 0) ||
            ((ref2 = this.document) != null
              ? ref2.getElementsByTagName("head")[0]
              : void 0) ||
            this.document.body
          );
        };
    ...
    (function () {
      ...
      Checkout = (function () {
        ...
        function Checkout(tokenCallback, options, configOptions) {
          ...
          var couldBeBrokenSFSVC,
            forceIframeViewFromQuery,
            isFullscreenMobileCapableViewport;
          ...
          this.isMobileWebView =
            ...
            helpers.isAndroidFacebookApp() ||
            helpers.isiOSWebView() ||
            helpers.isiOSBroken();
          couldBeBrokenSFSVC = helpers.couldBeBrokenSFSVC();
          isFullscreenMobileCapableViewport =
            helpers.isFullscreenMobileCapableViewport();
          forceIframeViewFromQuery =
            window.location.search.indexOf(
              "__stripe_private_force_mobile_frame=true"
            ) !== -1;
        ...
        Checkout.prototype.setOnToken = function (tokenCallback) {
          ...
          this.onToken = (function (_this) {
            return function (data) {
              return tokenCallback.trigger(
                data.token,
                data.args,
                _this.onTokenCallback
              );
            };
          })(this);
          return (ref = this.view) != null
            ? (ref.onToken = this.onToken)
            : void 0;
        };
        Checkout.prototype.createView = function () {
          ...
          tracker.track.manhattanStatusSet(false);
          views = { IframeView: IframeView, TabView: TabView };
          ...
          path =
            "/v3/YE6FAb8WEbhWWc3KIwa8w.html?distinct_id=" +
            tracker.getDistinctID();
        ...
        Checkout.prototype.open = function (options) {
          ...
          options.supportsTokenCallback =
            this.tokenCallback.supportsTokenCallback();
          iframeFallback = (function (_this) {
            return function () {
              if (!(_this.view instanceof TabView)) {
                return;
              }
              _this.view = new IframeView(
                _this.onToken,
                _this.host,
                "/v3/YE6FAb8WEbhWWc3KIwa8w.html"
              );
        ...
        Checkout.prototype.isLegacyIe = function () {
          return !(
            ...
            new XMLHttpRequest().withCredentials != null
          );
        };
        return Checkout;
      })();
  ...
  "outer/controllers/tokenCallback": function (exports, require, module) {
    (function () {
      ...
      TokenCallback = (function () {
        ...
        TokenCallback.prototype.trigger = function (
          token,
          addresses,
          callback
        ) {
    ...
    (function () {
      ...
      IframeView = (function (superClass) {
            ...
            (function (_this) {
              return function () {
                ...
                if (_this.shouldShowTouchOverlay()) {
                  ...
                  _this.frame.style.top =
                    (window.scrollY || window.pageYOffset) + "px";
        ...
        IframeView.prototype.opened = function () {
          var base;
          return typeof (base = this.options).opened === "function"
            ? base.opened()
            : void 0;
        };
        ...
        IframeView.prototype.shouldShowTouchOverlay = function () {
          return (
            !this.useFullscreenMobileIframe && helpers.isSupportedMobileOS()
          );
        };
        return IframeView;
      })(View);
    ...
    (function () {
      ...
      TabView = (function (superClass) {
        ...
        TabView.prototype.open = function (options, callback) {
          ...
          if (
            !this.frame &&
            ((ref1 = this.options.key) != null
              ? ref1.indexOf("test")
              : void 0) !== -1
          ) {
            url = "https://stripe.com/docs/checkout#integration-more-runloop";
            console.error(
              "Stripe Checkout was unable to open a new window, possibly due to a popup blocker.\nTo provide the best experience for your users, follow the guide at " +
                url +
        ...
        TabView.prototype.closed = function () {
          ...
          clearTimeout(this.tokenTimeout);
          this.invokeOnToken();
          return typeof (base = this.options).closed === "function"
            ? base.closed()
            : void 0;
        };
        ...
        View.prototype.triggerTokenCallback = function () {
          ...
          return this.rpc.ready(
            (function (_this) {
              return function () {
                var ref;
                return (ref = _this.rpc).invoke.apply(
                  ref,
                  ["tokenCallback"].concat(slice.call(args))
                );
              };
            })(this)
          );
...
(function () {
  var App, Button, app, ref, ref1, ref2, ref3, ref4, require;
  ...
  if (((ref = this.StripeCheckout) != null ? ref.__app : void 0) == null) {
    ...
    if (
      ((ref1 = this.StripeCheckout) != null ? ref1.__forceManhattan : void 0) !=
      null
    ) {
      app.setForceManhattan(this.StripeCheckout.__forceManhattan);
    }
    if (
      ((ref2 = this.StripeCheckout) != null ? ref2.__forceView : void 0) != null
    ) {
      app.setForceView(this.StripeCheckout.__forceView);
    }
    if (
      ((ref3 = this.StripeCheckout) != null ? ref3.__forceAppType : void 0) !=
      null
    ) {
      app.setForceAppType(this.StripeCheckout.__forceAppType);
    }
    if (
      ((ref4 = this.StripeCheckout) != null ? ref4.__host : void 0) &&
      this.StripeCheckout.__host !== ""
    ) {
